...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\USER\Desktop\Coding\beantrack\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\USER\\Desktop\\Coding\\beantrack\\public\\storage','logging.default','logging.deprecations.channel',
...
'livewire.update','livewire.upload-file','livewire.preview-file','column.chart','onboarding','role.select','show.create',
'show.login','create','login','logout','dashboard',
'storage.local',);
        registerArgumentsSet('views', 
'auth.create','auth.login','auth.onboarding','auth.welcome','components.column-graph-card',
'components.line-graph-card','components.ml-prediction-graph-card','components.orders-card','components.overview-card','components.partials.navbar-dashboard',
'components.partials.sidebar','components.progress-card','components.stats-card','components.table-card','dashboard',
'dashboard.admin','dashboard.supplier','dashboard.vendor','layouts.app','layouts.main-view',
'partials.main-view','sample','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar',
