...
<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
  <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-dashboard-light border-r border-hover-brown dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-dashboard-light lg:flex dark:bg-gray-800" sidebar-bottom-menu>
      <a href="#" class="inline-flex justify-center p-2 text-dashboard-text-light rounded cursor-pointer hover:text-dashboard-text-light hover:bg-light-brown dark:hover:bg-gray-700 dark:hover:text-white">
      ...
      <a href="#" data-tooltip-target="tooltip-settings" class="inline-flex justify-center p-2 text-dashboard-text-light rounded cursor-pointer hover:text-dashboard-text-light hover:bg-light-brown dark:hover:bg-gray-700 dark:hover:text-white">
      ...
      <button type="button" data-dropdown-toggle="language-dropdown" class="inline-flex justify-center p-2 text-dashboard-text-light rounded cursor-pointer hover:text-dashboard-text-light hover:bg-light-brown dark:hover:bg-gray-700 dark:hover:text-white">
      ...
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700" id="language-dropdown">
        <ul class="py-1" role="none">
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-light-brown dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
