<form id="createReportForm">
    ...
    <div class="wizard-step active" data-step="1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="template-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-light-brown" data-template="Vendor Purchases Report">
                <div class="flex items-center">
                    <i class="fas fa-shopping-bag text-soft-brown text-xl mr-3"></i>
                    <div>
                        <h5 class="font-medium text-dashboard-light">Vendor Purchases Report</h5>
                        <p class="text-sm text-soft-brown">Purchase history and order tracking</p>
                    </div>
                </div>
            </div>
            <div class="template-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-light-brown" data-template="Vendor Orders Report">
                <div class="flex items-center">
                    <i class="fas fa-clipboard-list text-light-brown text-xl mr-3"></i>
                    <div>
                        <h5 class="font-medium text-dashboard-light">Vendor Orders Report</h5>
                        <p class="text-sm text-soft-brown">Order status and fulfillment tracking</p>
                    </div>
                </div>
            </div>
            <div class="template-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-light-brown" data-template="Vendor Deliveries Report">
                <div class="flex items-center">
                    <i class="fas fa-truck text-light-brown text-xl mr-3"></i>
                    <div>
                        <h5 class="font-medium text-dashboard-light">Vendor Deliveries Report</h5>
                        <p class="text-sm text-soft-brown">Delivery schedules and performance</p>
                    </div>
                </div>
            </div>
            <div class="template-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-light-brown" data-template="Vendor Payments Report">
                <div class="flex items-center">
                    <i class="fas fa-credit-card text-light-brown text-xl mr-3"></i>
                    <div>
                        <h5 class="font-medium text-dashboard-light">Vendor Payments Report</h5>
                        <p class="text-sm text-soft-brown">Payment history and financial summaries</p>
                    </div>
                </div>
            </div>
            <div class="template-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer hover:border-light-brown" data-template="Vendor Inventory Report">
                <div class="flex items-center">
                    <i class="fas fa-boxes text-light-brown text-xl mr-3"></i>
                    <div>
                        <h5 class="font-medium text-dashboard-light">Vendor Inventory Report</h5>
