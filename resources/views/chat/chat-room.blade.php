        ...
        <div class="border-t p-4">
            <form id="chat-form" 
                ...
                <div class="flex flex-row items-center rounded-xl bg-white w-full px-4">
                    ...
                    <div class="ml-4">
                        <button type="submit" class="flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0 disabled:opacity-50">
                            <span>Send</span>
                            <span class="ml-2">
