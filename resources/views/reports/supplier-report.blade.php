                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="report-type" name="report_type" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-1 focus:ring-light-brown focus:border-light-brown">
                                ...
                                <option value="supplier_inventory">My Inventory Report</option>
                                <option value="supplier_orders">My Orders Report</option>
                                <option value="supplier_quality">My Quality Metrics</option>
                                <option value="supplier_deliveries">My Deliveries Report</option>
                            </select>
                        </div>
...
<x-wizard-modal 
    ...
    saveFunction="saveSupplierReportSchedule">
    <x-reports.supplier-wizard-content />
</x-wizard-modal>
...
@push('scripts')
<script src="{{ asset('js/supplier-reports.js') }}"></script>
