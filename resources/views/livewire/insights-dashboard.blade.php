<div>
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-warm-gray dark:text-gray-400">Vendor segmentation based on purchase behavior and order patterns</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-md">
            <h3 class="text-lg font-semibold text-coffee-brown dark:text-white mb-2">Total Vendors</h3>
            <div class="text-3xl font-bold text-light-brown">{{ $totalWholesalers }}</div>
            <p class="text-warm-gray dark:text-gray-400 text-sm mt-1">Active vendors in system</p>
        </div>
    ...
    <div class="mt-6 bg-white rounded-2xl shadow-md">
        <div class="p-6 border-b border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h3 class="text-xl font-bold text-coffee-brown">Vendor Segment Details</h3>
                    <p class="text-warm-gray text-sm mt-1">Individual vendor assignments and performance metrics</p>
                </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Showing {{ $wholesalerDetails->count() }} of {{ $totalWholesalers }} vendors
                </div>
                ...
                tooltip: {
                    y: {
                        formatter: function (val, { seriesIndex }) {
                            ...
                            return val + ' vendors<br/><span style="font-size: 11px; color: #666;">' + description + '</span>';
                        }
                    }
                }
            };
