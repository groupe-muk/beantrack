...
<div class="p-6">
    <div class="mb-6">
        ...
        <p class="mt-1 text-coffee-brown">Manage your vendor warehouses and workforce</p>
    </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow">
            <div class="flex justify-between items-center mb-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <form method="POST" action="{{ route('vendor.warehouses.destroy', $warehouse) }}" onsubmit="return confirm('Delete this warehouse?')">
                        @csrf
                        @method('DELETE')
            ...
            <form action="{{ route('vendor.warehouses.workers.store', $warehouse) }}" method="POST" class="mt-3">
                @csrf
