    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
            <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">Fill in the details for your new order</p>
            </div>
            ...
            <form action="{{ route('orders.vendor.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <!-- Product Selection -->
                <div>
                    <label for="coffee_product_id" class="block text-sm font-medium text-gray-700 mb-2">
...
function updateProductInfo() {
    ...
    if (select.value) {
        ...
        // Recalculate total if quantity is set
        calculateTotal();
    } else {
...
function calculateTotal() {
    ...
    const basePrice = 1000; // Base price per kg
