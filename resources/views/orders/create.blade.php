            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <form id="order-form" action="{{ route('orders.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="1" min="0" id="total_amount" name="total_amount" value="{{ old('total_amount') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 @error('total_amount') border-red-300 @enderror" required>
                        @error('total_amount')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Enter the total amount as a whole number (no decimals)</p>
                    </div>
