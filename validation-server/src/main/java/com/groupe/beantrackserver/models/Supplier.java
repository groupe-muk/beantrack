...
public class Supplier {
    ...
    @OneToOne // A Supplier has one User account
    @JoinColumn(name = "user_id", nullable = false, unique = true) // user_id is FK and also unique for Supplier
    private Users user;

    @ManyToOne // Many Suppliers can be linked to one SupplyCenter
