...
class SupplierWarehouseController extends Controller
{
    ...
    public function update(Request $request, Warehouse $warehouse)
    {
        ...
        // Check if warehouse belongs to current supplier
    ...
    public function updateWorker(Request $request, Worker $worker)
    {
        ...
        // Check if worker's warehouse belongs to current supplier
        if ($worker->warehouse->supplier_id !== $supplier->id) {
            return redirect()->back()->with('error', 'Unauthorized access.');
        }
    ...
    public function uploadWorkers(Request $request)
    {
        ...
        try {
            ...
            // Get all supplier warehouses for random assignment
